...
public class Controller {
    ...
    public void btnSubmit(ActionEvent event) {
        ...
        //check whether there still have available words in letters' bag.
        if (!isGameOver()) {

            //validate input word.
            if (isValidWord()) {

                //check each letter used has remaining in letters' bag.
                try {
                    if (isValidWordBag()) {

                        //if word is qualified，add this word to words array and get total points.
                        words.add(word);
                        errMsg.setText("");
                        userInput.setText("");
                        grades.setText(Integer.toString(gradeCount()));
                        //check whether disappear image
                        disappearImg();
                    }
    ...
    ////show previous words button event.
    @FXML
    public void btnPreWords(ActionEvent event) {
    ...
    */
    ...
    /*
    return false if: Word contains letter that is no longer available in letter's bag
    calculate the remaining in letters' bag.
    */
    ...
    //get total point according to lettersMap.
    ...
    Message of “Game Over” displayed when they are no possible valid words to enter
        ...
        • only consonants remaining in bag
     */
    ...
    //Letters' image disappears when no more remaining
